...
import { BufferGeometry, Material, SkinnedMesh as SkinnedMeshBase } from "three/index";
import { Cursor, Events, Object3DExtPrototype } from "../index";

export class SkinnedMesh<
    TGeometry extends BufferGeometry = BufferGeometry,
    TMaterial extends Material | Material[] = Material | Material[],
> extends SkinnedMeshBase<TGeometry, TMaterial> implements Object3DExtPrototype {
    enabled: boolean;
